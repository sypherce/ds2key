...
using D2K::GUI::MainWindow;

D2K::GUI::MainWindow *GUI::mainWindow;
...
void edit1Function() {
	char *ipString = KeyPadEdit(label3, edit1, DS2Key::GetIPString(), D2K::System::LENGTH_IP);
...
void edit2Function() {
	char *portString = KeyPadEdit(label4, edit2, DS2Key::GetPortString(), D2K::System::LENGTH_PORT);
...
void edit3Function() {
	char *profileString = KeyPadEdit(label5, edit3, DS2Key::GetProfileString(), D2K::System::LENGTH_PROFILE);
